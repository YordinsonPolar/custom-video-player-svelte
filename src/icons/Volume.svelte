  ...
  <defs>
    <linearGradient id="volume" gradientUnits="userSpaceOnUse" fy="90%">
      <stop offset="0" style="stop-color:#4dadfe" />
      <stop offset="0.5" style="stop-color:#03f0fe" />
      <stop offset="1" style="stop-color:#41b9fe" />
    </linearGradient>
    <mask id="volume-icon-mask" maskUnits="userSpaceOnUse" x="0" y="0" width="512" height="512">
